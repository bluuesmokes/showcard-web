...
import { AlignLeft, Maximize2, Palette, Type, Layout, Download, Loader2, AlignCenter, AlignRight, Eye, EyeOff, ImagePlus, Upload } from 'lucide-react';
...
export default function EditorPanel({
  ...
  return (
    <aside className="w-full md:w-[460px] h-[62vh] md:h-full bg-[var(--md-sys-color-surface-container-low)] border-t md:border-t-0 md:border-l border-white/10 z-30 shadow-2xl shrink-0 flex flex-col overflow-hidden">
        ...
        {TABS.map(({ id, label }) => {
          ...
          return (
            <button
              ...
              className={`flex-1 flex flex-col items-center gap-0.5 py-2.5 text-[9px] font-extrabold uppercase tracking-widest transition-colors cursor-pointer border-b-2 ${
                active
      ...
      <div className="flex-1 overflow-y-auto min-h-0 p-4 sm:p-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 min-w-0 px-3 py-2 bg-[var(--md-sys-color-surface-container-highest)] rounded-xl border border-[var(--md-sys-color-outline-variant)]/30 text-xs font-mono text-white outline-none focus:border-[var(--md-sys-color-primary)]"
                  />
              ...
              <div className="grid grid-cols-2 gap-3 min-w-0">
                <div className="space-y-1 min-w-0">
                  ...
                  <div className="flex gap-1.5">
                    <input
                      ...
                      className="flex-1 min-w-0 px-2.5 py-1.5 bg-[var(--md-sys-color-surface-container-highest)] rounded-lg border border-[var(--md-sys-color-outline-variant)]/30 text-[11px] font-mono text-white outline-none"
                    />
                    <div className="relative shrink-0">
                      <input type="color" value={config.gradientStart} onChange={e => setConfig(p => ({ ...p, gradientStart: e.target.value }))} className="absolute inset-0 w-7 h-7 opacity-0 cursor-pointer" />
                ...
                <div className="space-y-1 min-w-0">
                  ...
                  <div className="flex gap-1.5">
                    ...
                    />
                    <div className="relative shrink-0">
                      <input type="color" value={config.gradientEnd} onChange={e => setConfig(p => ({ ...p, gradientEnd: e.target.value }))} className="absolute inset-0 w-7 h-7 opacity-0 cursor-pointer" />
                ...
                <div className="space-y-3 pt-2">
                  <div className="flex gap-2 items-center">
                    <input
                      ...
                      className="flex-1 min-w-0 px-3 py-2 bg-[var(--md-sys-color-surface-container-highest)] rounded-xl border border-[var(--md-sys-color-outline-variant)]/30 text-xs font-mono text-white outline-none"
                    />
                    <div className="relative shrink-0">
                      <input type="color" value={config.solidBgColor} onChange={e => setConfig(p => ({ ...p, solidBgColor: e.target.value }))} className="absolute inset-0 w-9 h-9 opacity-0 cursor-pointer" />
                  ...
                  <div className="grid grid-cols-2 gap-3 min-w-0">
                    <div className="space-y-1 min-w-0">
                      ...
                      <div className="flex gap-1.5">
                        ...
                        />
                        <div className="relative shrink-0">
                          <input type="color" value={config.bgGradientStart || '#000000'} onChange={e => setConfig(p => ({ ...p, bgGradientStart: e.target.value }))} className="absolute inset-0 w-7 h-7 opacity-0 cursor-pointer" />
                    ...
                    <div className="space-y-1 min-w-0">
                      ...
                      <div className="flex gap-1.5">
                        ...
                        />
                        <div className="relative shrink-0">
                          <input type="color" value={config.bgGradientEnd || '#2c2c2c'} onChange={e => setConfig(p => ({ ...p, bgGradientEnd: e.target.value }))} className="absolute inset-0 w-7 h-7 opacity-0 cursor-pointer" />
        ...
        {activeTab === 'type' && (
          <div className="space-y-5 text-left">
            ...
            <div className="grid grid-cols-2 gap-4 min-w-0 pt-1">
      ...
      {/* Pinned Save Button — outside scroll, matching panel background */}
      <div className="shrink-0 px-4 pb-4 pt-3 bg-[var(--md-sys-color-surface-container-low)] border-t border-white/5">
        <button
          onClick={onDownload}
